{
  description = "Apollo development flake";
  ...
  outputs =
    ...
    let
      ...
      packageJson = builtins.fromJSON (builtins.readFile ./packages/apollo/package.json);
      bunTarget = {
    ...
    in
    {
      ...
      packages = forEachSystem (
        ...
        let
          ...
          mkApollo = pkgs.callPackage ./nix/apollo.nix { };
        ...
        in
        {
          default = self.packages.${system}.apollo;
          apollo = apolloPkg;
          desktop = desktopPkg;
        }
      );
