...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/apollo.git")).toEqual({ owner: "sst", repo: "apollo" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/apollo")).toEqual({ owner: "sst", repo: "apollo" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/apollo.git")).toEqual({ owner: "sst", repo: "apollo" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/apollo")).toEqual({ owner: "sst", repo: "apollo" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/apollo.git")).toEqual({ owner: "sst", repo: "apollo" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/apollo")).toEqual({ owner: "sst", repo: "apollo" })
})
