...
const STORAGE_KEYS = {
  THEME_ID: "apollo-theme-id",
  COLOR_SCHEME: "apollo-color-scheme",
  THEME_CSS_LIGHT: "apollo-theme-css-light",
  THEME_CSS_DARK: "apollo-theme-css-dark",
} as const

const THEME_STYLE_ID = "apollo-theme"
...
function applyThemeCss(theme: DesktopTheme, themeId: string, mode: "light" | "dark") {
  ...
  document.getElementById("apollo-theme-preload")?.remove()
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { defaultTheme?: string }) => {
    const [store, setStore] = createStore({
      ...
      themeId: props.defaultTheme ?? "apollo-1",
