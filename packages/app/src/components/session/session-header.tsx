...
import { base64Decode } from "@apollo-ai/util/encode"
...
import { Popover } from "@apollo-ai/ui/popover"
import { TextField } from "@apollo-ai/ui/text-field"
import { Keybind } from "@apollo-ai/ui/keybind"
...
export function SessionHeader() {
  ...
  const centerMount = createMemo(() => document.getElementById("apollo-titlebar-center"))
  const rightMount = createMemo(() => document.getElementById("apollo-titlebar-right"))
