import solidPlugin from "./packages/apollo/node_modules/@opentui/solid/scripts/solid-plugin"
import path from "path"
import fs from "fs"

const version = "@VERSION@"
const pkg = path.join(process.cwd(), "packages/apollo")
...
const manifestName = "apollo-assets.manifest"
...
const result = await Bun.build({
  ...
  compile: {
    ...
    execArgv: ["--user-agent=apollo/" + version, "--use-system-ca", "--"],
    windows: {},
  },
})
...
const dest = path.join(pkg, "apollo-worker.js")
