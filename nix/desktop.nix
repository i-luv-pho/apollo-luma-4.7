...
rustPlatform.buildRustPackage rec {
  ...
  preBuild = ''
    ...
    cp ${args.apollo}/bin/apollo packages/desktop/src-tauri/sidecars/apollo-cli-$targetTriple
  ...
  postInstall = lib.optionalString stdenv.isLinux ''
    ...
    cp ../../../packages/desktop/src-tauri/icons/prod/128x128.png $out/share/icons/hicolor/128x128/apps/apollo.png

    # Wrap the binary to ensure it finds the libraries
    wrapProgram $out/bin/apollo-desktop \
  ...
  meta = with lib; {
    description = "Apollo Desktop App";
    homepage = "https://apollo.ai";
    license = licenses.mit;
    maintainers = with maintainers; [ ];
    mainProgram = "apollo-desktop";
