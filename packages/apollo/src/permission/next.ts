...
export namespace PermissionNext {
  ...
  // Permission requests timeout after 10 minutes if unanswered
  ...
  /** Permission request timed out - halts execution */
  export class TimeoutError extends Error {
    constructor() {
      super(`Permission request timed out after ${PERMISSION_TIMEOUT_MS / 1000 / 60} minutes without a response.`)
    }
  }
