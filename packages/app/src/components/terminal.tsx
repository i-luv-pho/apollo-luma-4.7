...
import { resolveThemeVariant, useTheme, withAlpha, type HexColor } from "@apollo-ai/ui/theme"
...
export const Terminal = (props: TerminalProps) => {
  ...
  let handleWsOpen: () => void
  let handleWsMessage: (event: MessageEvent) => void
  let handleWsError: (error: Event) => void
  let handleWsClose: () => void
  ...
  onMount(async () => {
    ...
    if (window.__APOLLO__?.serverPassword) {
      url.username = "apollo"
      url.password = window.__APOLLO__?.serverPassword
    }
