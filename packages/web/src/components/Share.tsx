...
import { IconApollo } from "./icons/custom"
import styles from "./share.module.css"
import type { MessageV2 } from "apollo/session/message-v2"
import type { Message } from "apollo/session/message"
import type { Session } from "apollo/session/index"
...
export default function Share(props: { id: string; api: string; info: Session.Info }) {
  ...
  // Fixed: Handle undefined IDs in sort comparator to prevent runtime errors
  const messages = createMemo(() => Object.values(store.messages).toSorted((a, b) => {
  ...
  onMount(() => {
    ...
    const setupWebSocket = () => {
      ...
      // Connection timeout - if not connected within 15 seconds, retry
        ...
        <div data-component="header">
          ...
          <div data-component="header-details">
            <ul data-component="header-stats">
              <li title="apollo version" data-slot="item">
                <div data-slot="icon" title="apollo">
                  <IconApollo width={16} height={16} />
                </div>
