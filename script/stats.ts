...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/i-luv-pho/apollov2/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for i-luv-pho/apollov2...\n")
...
console.log("Fetching npm all-time downloads for apollo-ai...\n")
const npmDownloads = await fetchNpmDownloads("apollo-ai")
