import type { ProviderAuthAuthorization } from "@apollo-ai/sdk/v2/client"
...
import type { IconName } from "@apollo-ai/ui/icons/provider"
import { List, type ListRef } from "@apollo-ai/ui/list"
import { ProviderIcon } from "@apollo-ai/ui/provider-icon"
import { Spinner } from "@apollo-ai/ui/spinner"
import { TextField } from "@apollo-ai/ui/text-field"
import { showToast } from "@apollo-ai/ui/toast"
import { iife } from "@apollo-ai/util/iife"
              ...
              {iife(() => {
                ...
                return (
                  <div class="flex flex-col gap-6">
                    <Switch>
                      <Match when={provider().id === "apollo"}>
                        <div class="flex flex-col gap-4">
                          <div class="text-14-regular text-text-base">
                            Apollo Zen gives you access to a curated set of reliable optimized models for coding
                            agents.
                          </div>
                          <div class="text-14-regular text-text-base">
                            With a single API key you'll get access to models such as GPT, Gemini, GLM and more.
                          </div>
                          <div class="text-14-regular text-text-base">
                            Visit{" "}
                            <Link href="https://github.com/i-luv-pho/apollov2/zen" tabIndex={-1}>
                              github.com/i-luv-pho/apollov2/zen
                            </Link>{" "}
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          code to connect your account and use {provider().name} models in Apollo.
                        </div>
                        <form onSubmit={handleSubmit} class="flex flex-col items-start gap-4">
                          <TextField
                            autofocus
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          connect your account and use {provider().name} models in Apollo.
                        </div>
