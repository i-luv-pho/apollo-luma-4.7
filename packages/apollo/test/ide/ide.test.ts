...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders APOLLO_CALLER", () => {
    process.env["APOLLO_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode APOLLO_CALLER", () => {
    process.env["APOLLO_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown APOLLO_CALLER", () => {
    process.env["APOLLO_CALLER"] = "unknown"
