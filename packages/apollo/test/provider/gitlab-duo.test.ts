...
const mockPlugin = () => ({})
mock.module("apollo-copilot-auth", () => ({ default: mockPlugin }))
mock.module("apollo-anthropic-auth", () => ({ default: mockPlugin }))
mock.module("@gitlab/apollo-gitlab-auth", () => ({ default: mockPlugin }))
