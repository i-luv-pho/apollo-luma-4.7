...
Custom commands are in addition to the built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/summarize`, `/help`. [Learn more](/docs/tui#commands).
...
Create `.apollo/commands/test.md`:

```md title=".apollo/commands/test.md"
---
...
You can add custom commands through the Apollo config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Apollo [config](/docs/config):

```json title="apollo.jsonc" {4-12}
{
...
- Global: `~/.config/apollo/commands/`
- Per-project: `.apollo/commands/`

```markdown title="~/.config/apollo/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".apollo/commands/component.md"
---
...
```md title=".apollo/commands/create-file.md"
---
...
```md title=".apollo/commands/analyze-coverage.md"
---
...
```md title=".apollo/commands/review-changes.md"
---
...
```md title=".apollo/commands/review-component.md"
---
...
apollo includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/summarize`, `/help`; [learn more](/docs/tui#commands).
