---
title: TUI
description: Using the Apollo terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Apollo provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Apollo starts the TUI for the current directory.
...
When using the Apollo TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Apollo. Allows you to select from available providers and add their API keys.
...
Summarize and compact the current session. _Alias_: `/compact`
...
List and switch between sessions. _Alias_: `/resume`
...
You can customize TUI behavior through your Apollo config file.
