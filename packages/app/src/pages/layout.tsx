...
import { base64Decode, base64Encode } from "@apollo-ai/util/encode"
import { Avatar } from "@apollo-ai/ui/avatar"
import { ResizeHandle } from "@apollo-ai/ui/resize-handle"
import { Button } from "@apollo-ai/ui/button"
import { Icon } from "@apollo-ai/ui/icon"
import { IconButton } from "@apollo-ai/ui/icon-button"
import { InlineInput } from "@apollo-ai/ui/inline-input"
import { Tooltip, TooltipKeybind } from "@apollo-ai/ui/tooltip"
import { HoverCard } from "@apollo-ai/ui/hover-card"
import { DropdownMenu } from "@apollo-ai/ui/dropdown-menu"
import { Collapsible } from "@apollo-ai/ui/collapsible"
import { DiffChanges } from "@apollo-ai/ui/diff-changes"
import { Spinner } from "@apollo-ai/ui/spinner"
import { getFilename } from "@apollo-ai/util/path"
import { Session } from "@apollo-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@apollo-ai/ui/toast"
import { useGlobalSDK } from "@/context/global-sdk"
import { useNotification } from "@/context/notification"
import { usePermission } from "@/context/permission"
import { Binary } from "@apollo-ai/util/binary"
import { retry } from "@apollo-ai/util/retry"

import { useDialog } from "@apollo-ai/ui/context/dialog"
import { useTheme, type ColorScheme } from "@apollo-ai/ui/theme"
...
export default function Layout(props: ParentProps) {
    ...
    async function pollUpdate() {
      ...
      if (updateAvailable && toastId === undefined) {
        toastId = showToast({
          ...
          description: `A new version of Apollo (${version}) is now available to install.`,
          actions: [
            {
  ...
  const ProjectIcon = (props: { project: LocalProject; class?: string; notify?: boolean }): JSX.Element => {
    ...
    const apollo = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    return (
      <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
        <div class="size-full rounded overflow-clip">
          <Avatar
            fallback={name()}
            src={props.project.id === apollo ? "https://github.com/i-luv-pho/apollov2/favicon.svg" : props.project.icon?.url}
          ...
          <div class="shrink-0 w-full pt-3 pb-3 flex flex-col items-center gap-2">
            ...
            <Tooltip placement={sidebarProps.mobile ? "bottom" : "right"} value="Help">
              <IconButton
                ...
                variant="ghost"
                size="large"
                onClick={() => platform.openLink("https://github.com/i-luv-pho/apollov2/desktop-feedback")}
              />
            </Tooltip>
          </div>
        </div>
              ...
              <div class="shrink-0 px-2 py-3 border-t border-border-weak-base">
                <div class="rounded-md bg-background-base shadow-xs-border-base">
                  <div class="p-3 flex flex-col gap-2">
                    ...
                    <div class="text-text-base">Apollo includes free models so you can start immediately.</div>
                    <div class="text-text-base">Connect any provider to use models like GPT, Gemini, and more.</div>
                  </div>
                  <Button
    ...
    <div class="relative bg-background-base flex-1 min-h-0 flex flex-col select-none [&_input]:select-text [&_textarea]:select-text [&_[contenteditable]]:select-text">
      ...
      <div class="flex-1 min-h-0 flex">
        <div
          ...
          style={{ width: layout.sidebar.opened() ? `${Math.max(layout.sidebar.width(), 220)}px` : "64px" }}
        >
